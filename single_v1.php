      ...
      <div class="col-sm-12 col-md-8">
        ...
        <article class="article-wrap main-column" id="<?php the_ID(); ?>" <?php post_class(); ?>>
          ...
          <ul id="review-tabs" class="nav nav-tabs" role="tablist">
            <li role="presentation"><a href="#diy" aria-controls="diy" role="tab" data-toggle="tab">DIY</a></li>
            <li role="presentation"><a href="#video" aria-controls="video" role="tab" data-toggle="tab">Video of the Product</a></li>
            <li role="presentation"><a href="#community" aria-controls="community" role="tab" data-toggle="tab">Community Review</a></li>
            <li role="presentation" class="active"><a href="#professional" aria-controls="professional" role="tab" data-toggle="tab">Professional Review</a></li>
          </ul>
