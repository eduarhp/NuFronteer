...
define( 'NOTIFIER_THEME_NAME', 'saviour' ); // The theme name
define( 'NOTIFIER_THEME_FOLDER_NAME', 'saviour' ); // The theme folder name
define( 'NOTIFIER_XML_FILE', 'http://www.swiftpsd.com/themes/saviour/notifier.xml' ); // The remote notifier XML file containing the latest version of the theme and changelog
